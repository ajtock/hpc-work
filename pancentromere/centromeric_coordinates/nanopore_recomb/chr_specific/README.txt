...
7. Via multiple slurm array jobs (number of tasks informed by number of hybrid reads found), run hybrid_read_segments_acc_chr_specific_kmers.py to get accession-specific read segments and align them either to one genome assembly (for not_centromere) or respective genome assembly (for centromere). Note customisable variables maxAlns, minMAPQ and bt2maxLen.
