...
# sbatch reads_acc_chr_specific_kmers_bbduk_icelake_slurm
# sbatch reads_acc1_AND_acc2_chr_specific_kmers_bbduk_icelake_slurm ):
# conda activate python_3.9.6
# ./reads_acc_chr_specific_kmers_bbduk.sh 256g 76 Col_Ler_F1_pollen_500bp_minq99 Col-0.ragtag_scaffolds_not_centromere_Chr1_specific_k 24 0.9 10
# ./reads_acc_chr_specific_kmers_bbduk.sh 256g 76 Col_Ler_F1_pollen_500bp_minq99 Ler-0_110x.ragtag_scaffolds_not_centromere_Chr1_specific_k 24 0.9 10
# ./reads_acc_chr_specific_kmers_bbduk.sh 256g 76 Col_Ler_F1_pollen_500bp_minq99_match_Col-0.ragtag_scaffolds_not_centromere_Chr1_specific_k24_downsampled_op0.9_hits10 Ler-0_110x.ragtag_scaffolds_not_centromere_Chr1_specific_k 24 0.9 10
# ./reads_acc_chr_specific_kmers_bbduk.sh 256g 76 Col_Ler_F1_pollen_500bp_minq99_match_Ler-0_110x.ragtag_scaffolds_not_centromere_Chr1_specific_k24_downsampled_op0.9_hits10 Col-0.ragtag_scaffolds_not_centromere_Chr1_specific_k 24 0.9 10
# conda deactivate
