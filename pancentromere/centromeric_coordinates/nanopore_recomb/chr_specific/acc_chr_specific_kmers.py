...
# Usage (sbatch acc_chr_specific_kmers_icelake_slurm)
# conda activate python_3.9.6
# ./acc_chr_specific_kmers.py -a1c Col-0.ragtag_scaffolds_centromere -a2c Ler-0_110x.ragtag_scaffolds_centromere -a1nc Col-0.ragtag_scaffolds_not_centromere -a2nc Ler-0_110x.ragtag_scaffolds_not_centromere -c Chr1 -k 24 -op 0.9 
# conda deactivate
