...
# ./get_centromere_coordinates.R Col-0.ragtag_scaffolds 'Chr1,Chr2,Chr3,Chr4,Chr5'
# ./get_centromere_coordinates.R Ler-0_110x.ragtag_scaffolds 'Chr1,Chr2,Chr3,Chr4,Chr5'
# conda deactivate

#accName <- "Col-0.ragtag_scaffolds"
#accName <- "Ler-0_110x.ragtag_scaffolds"
