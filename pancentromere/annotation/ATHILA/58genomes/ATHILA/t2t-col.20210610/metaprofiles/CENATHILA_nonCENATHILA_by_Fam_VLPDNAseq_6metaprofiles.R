...
# Usage:
# ./CENATHILA_nonCENATHILA_by_Fam_VLPDNAseq_6metaprofiles.R 'Chr1,Chr2,Chr3,Chr4,Chr5' both 180 2000 2000 2000 2kb 10 10 10bp 10bp '0.02,0.96' 'Col_0_VLPDNAseq_Rep1_SRR8792541,Col_0_VLPDNAseq_Rep2_SRR8792542,ddm1_2_VLPDNAseq_Rep1_SRR8792544,ddm1_2_VLPDNAseq_Rep2_SRR8792545,ddm1_2_rdr6_15_VLPDNAseq_Rep1_SRR8792546,ddm1_2_rdr6_15_VLPDNAseq_Rep2_SRR8792547' 'VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_' 'Col-0 Rep1,Col-0 Rep2,ddm1-2 Rep1,ddm1-2 Rep2,ddm1-2 rdr6-15 Rep1,ddm1-2 rdr6-15 Rep2' 'springgreen2,forestgreen,dodgerblue1,dodgerblue3,navy,darkslateblue' ATHILA1 t2t-col.20210610
...
#                                        split = ",")))
#ChIPNames <- unlist(strsplit("Col_0_VLPDNAseq_Rep1_SRR8792541,Col_0_VLPDNAseq_Rep2_SRR8792542,ddm1_2_VLPDNAseq_Rep1_SRR8792544,ddm1_2_VLPDNAseq_Rep2_SRR8792545,ddm1_2_rdr6_15_VLPDNAseq_Rep1_SRR8792546,ddm1_2_rdr6_15_VLPDNAseq_Rep2_SRR8792547",
#                             split = ","))
#ChIPNamesDir <- unlist(strsplit("VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_,VLPDNAseq_floral_Lee_Martienssen_2020_GenomeRes/snakemake_VLPDNAseq_STAR_",
#                                split = ","))
#ChIPNamesPlot <- unlist(strsplit("Col-0 Rep1,Col-0 Rep2,ddm1-2 Rep1,ddm1-2 Rep2,ddm1-2 rdr6-15 Rep1,ddm1-2 rdr6-15 Rep2",
#                                 split = ","))
#ChIPColours <- unlist(strsplit("springgreen2,forestgreen,dodgerblue1,dodgerblue3,navy,darkslateblue",
#                               split = ","))
#ATHILAFam <- "ATHILA1"
...
yLabPlot <- paste0("VLP DNA-seq (TPM)")
...
#  lapply(seq_along(chrName), function(y) {
    as.matrix(read.table(paste0(ChIPDirs[x], "ATHILAprofiles/matrices/",
                                ChIPNames[x],
                                "_MappedOn_", refbase, "_", align, "_sort_norm_CENATHILA_in_",
...
#  lapply(seq_along(chrName), function(y) {
    as.matrix(read.table(paste0(ChIPDirs[x], "ATHILAprofiles/matrices/",
                                ChIPNames[x],
                                "_MappedOn_", refbase, "_", align, "_sort_norm_nonCENATHILA_in_",
                                paste0(chrName, collapse = "_"), "_matrix_bin", binSize, "bp_flank", flankName, ".tab"),
                         header = F, skip = 3))
#  })
}, mc.cores = length(ChIPNames))
...
ggsave(paste0(plotDir,
              "VLPDNAseq_",
              paste0(ChIPNames[1], "_", ChIPNames[length(ChIPNames)]),
              "_avgProfiles_around",
              "_CEN", ATHILAFam, "Fam",
              "_CENranLoc",
...
ggsave(paste0(plotDir_log2,
              "VLPDNAseq_log2_",
              paste0(log2ChIPNames[1], "_", log2ChIPNames[length(log2ChIPNames)]),
              "_avgProfiles_around",
              "_CEN", ATHILAFam, "Fam",
              "_CENranLoc",
              "_nonCEN", ATHILAFam, "Fam",
